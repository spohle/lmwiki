...
class RawMarkdownListWidget(QListWidget):
    ...
    def __init__(
        ...
        # No QSS on this widget: Qt ignores QListWidgetItem.setBackground when the list has a stylesheet.
...
class MainWindow(QMainWindow):
    ...
    def _build_body(self) -> QWidget:
        ...
        synth_extra.clicked.connect(self._stub_synthesize_all)
        synth = _content_page(
            "Synthesize",
    ...
    def _build_raw_files_panel(self) -> QWidget:
        ...
        self._raw_file_list.setObjectName("rawFileList")
        ...
        self._btn_synth_selected.clicked.connect(self._stub_synthesize_selected)
        self._btn_synth_all = QPushButton("Synthesize All")
        self._btn_synth_all.setObjectName("rawSynthAll")
        self._btn_synth_all.clicked.connect(self._stub_synthesize_all)
    ...
    @staticmethod
    def _stub_synthesize_selected() -> None:
        pass
